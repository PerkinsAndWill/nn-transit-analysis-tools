...
write_rds(sub_route_ref,paste0(full_output_folder,"/trimet_route_reference.rds"))
...
htmlwidgets::saveWidget(map_obj,file = "docs/transit-supply-example-maps/trimet-example-hex.html")
